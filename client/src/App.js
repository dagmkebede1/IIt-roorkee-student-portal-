...
<Header/>
      <Routes>
        ...
        <Route exact path='/btechSectionUpload' element ={<ToUploadForBTech/>}/>
        <Route exact path='/mtechSectioUpload' element ={<ToUploadForMtech/>}/>
        <Route exact path='/phdSectionUpload' element ={<ToUploadForPhd/>}/>
        <Route exact path='/btechSectionDisplay' element ={<ToDisplayForBTech/>}/>
        <Route exact path='/mtechSectioDisplay' element ={<ToDisplayMtech/>}/>
        <Route exact path='/phdSectionDisplay' element ={<ToDisplayForPhd/>}/>
        <Route exact path='/buyorsell' element ={<BuyOrSell/>}/>
        <Route exact path='/dashbord' element ={<PotectRoute><DashBord/></PotectRoute>}/>
        <Route exact path='/updateProfile' element ={<UpdateUserProfile/>}/>
        <Route exact path='/deleteProfile' element ={<DeleteUserPage/>}/>
        <Route exact path='/uploadNotification' element ={<UplaodNotifcations/>}/>
