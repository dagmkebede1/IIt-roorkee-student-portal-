...
const [newEmail, setNewEmail] = useState({
    new_password_one :"",
    new_password_two:"",
    user_email_new_password:emailToPass
});
          ...
          <div className="container py-5 d-md-flex justify-content-between login_container">
            <div className="main col-12 col-md-6 me-md-2 p-5 d-flex flex-column justify-content-center">
              ...
              <p className="p2 text-center">
                You Want To LogIn?<Link to='/login' className="a3"> Click Here To LogIn</Link>
              </p>
              <form onSubmit={newPass}>
                ...
                <input className="in1" type={type}  name="new_password_one"  placeholder="New Password" required autoComplete="new-password" onChange={handle_change} />
                <span className="showHide ">
                <Icon icon={icon} size={20} onClick={HandleIconChange} />
              </span>
                <input className="in111" type={type} onPaste={handlePaste} name="new_password_two"  placeholder="Confirm Password" required autoComplete="new-password" onChange={handle_change} />
                <span className="showHide ">
              </span>
