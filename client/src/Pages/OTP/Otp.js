...
if(response){
  if(response.confirmation === 'true'){
    return <emailForNewPass.Provider value={forOtp.email_OTP}>
            <NewPassword/>
        ...
        <div className="container py-5 d-md-flex justify-content-between login_container">
          ...
          <p className="p1">Please Pass OTP?</p>
            ...
            <form onSubmit={OTPset} >
              ...
              <input className="in1" type="text" name="OTP"  placeholder="Please pass your four digit OTP here..." required autoComplete="new-password" onChange={handelChangeOTP}/>
